<?php
session_start();
// 1. Updated Database Path (Going up from Teams&history1)
...
<head>
    ...
    <style>
        ...
        .score-card { background: white; border: 3px solid #0A192F; border-radius: 20px; padding: 40px; margin-top: 20px; position: relative; }
        ...
        /* Back Button Style */
        .back-nav { padding-top: 20px; text-align: left; }
        .btn-back { color: #0A192F; text-decoration: none; font-weight: bold; font-size: 1.1rem; }
        .btn-back:hover { color: #FFB800; }
    </style>
</head>
<body>
    ...
    <div class="container text-center">
        <div class="score-card shadow">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <h3 class="fw-bold"><?= strtoupper($match['home_team'] ?? 'Home') ?></h3>
                ...
                <div class="col-md-2">
                    <h1 class="text-warning fw-900" style="font-family:'Outfit';">VS</h1>
                </div>

                <div class="col-md-5">
                    <h3 class="fw-bold"><?= strtoupper($match['away_team'] ?? 'Away') ?></h3>
